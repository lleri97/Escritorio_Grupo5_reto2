 ...
 * USAGE:
 * <pre>
 *        AreaClientService client = new AreaClientService();
 ...
 * @author Yeray
 */
public class AreaClientService {
    ...
    public AreaClientService() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("area");
    }

    public <T> T FindAllArea(GenericType<T> responseType) throws ClientErrorException {
    ...
    public <T> T find(GenericType<T> responseType, int id) throws ClientErrorException {
        WebTarget resource = webTarget;
